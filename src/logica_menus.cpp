...
#include <stdexcept>
#include <limits>
#include "../include/logica_menus.h"
...
void gerenciarVendas() {
    ...
    do {
        ...
        try {
            ...
            // Se a leitura falhar, lança exceção
            if (cin.fail()) {
                throw runtime_error("Entrada inválida! Digite apenas números de 1 a 3.");
            }
            ...
            switch (opcaoVendas) {
                ...
                case 3:
                    ...
                    break;
                default:
                    throw runtime_error("Opção inválida! Digite um número entre 1 e 3.");
            }
